          ...
          <div class="container-fluid">
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                <div class="input-group-static">
                  ...
                  <span id="price-error-create" class="text-danger"></span>
                </div>
              </div>
              <div class="col-md-6">
                <div class="input-group-static">
                  ...
                  <span id="sale-error-create" class="text-danger"></span>
                </div>
              </div>
            </div>
            <div class="col-md-12 mb-3">
              ...
              <div class="form-group">
                  ...
                  <span id="category_ids-error-create" class="text-danger"></span>
              </div>
            </div>
            <div class="col-md-12 mb-3">
              <div class="input-group-static">
                ...
                <span id="description-error-create" class="text-danger"></span>
              </div>
            </div>
          </div>
